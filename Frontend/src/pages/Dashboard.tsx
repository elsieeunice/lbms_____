...
const StatCard = ({
  ...
  return (
    <div className="bg-black rounded-2xl border border-white/10 p-6">
      ...
      <div className="mt-4">
        <p className="text-sm text-gray-300">{metricLabel}</p>
    ...
    <div className="p-6 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
        <StatCard
          ...
          trend={{ text: '+12%', direction: 'up', toneClassName: 'bg-cyan-500/10 text-cyan-200 border border-cyan-500/20' }}
        ...
        <StatCard
          ...
          iconBgClassName="bg-white"
          trend={{ text: '+8%', direction: 'up', toneClassName: 'bg-cyan-500/10 text-cyan-200 border border-cyan-500/20' }}
        ...
        <StatCard
          ...
          iconBgClassName="bg-white"
          trend={{ text: '+25%', direction: 'up', toneClassName: 'bg-cyan-500/10 text-cyan-200 border border-cyan-500/20' }}
        ...
        <StatCard
          ...
          trend={{
            text: '23 Overdue',
            direction: 'down',
            toneClassName: 'bg-cyan-500/10 text-cyan-200 border border-cyan-500/20',
          }}
      ...
      <div className="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="bg-gray-200 rounded-2xl border border-gray-300/70 p-6">
          ...
          <div className="mt-4 space-y-3">
            {recentActivity.map((item) => (
              <div
                key={item.id}
                className="flex items-start gap-3 rounded-xl border border-gray-300/70 bg-white/60 p-3"
              >
                <div className="rounded-lg bg-cyan-500/20 text-cyan-700 p-2">{item.icon}</div>
        ...
        <div className="bg-gray-200 rounded-2xl border border-gray-300/70 p-6">
          ...
          <div className="mt-4 space-y-5 relative">
            {popularBooks.map((book, idx) => (
              <div
                key={book.id}
                className="flex items-center gap-3 border border-gray-300/70 bg-white/60 p-3 pl-12 relative"
              >
                <div
                ...
                <div className="absolute z-20 left-3 w-[45px] h-16 bg-cyan-500 border border-cyan-500 flex items-center justify-center text-cyan-700">
